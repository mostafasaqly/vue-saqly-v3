  ...
  >
    ...
    <div class="sidebar__brand">
      ...
      <div class="sidebar__brand-small">
        ...
        <a
          href="https://mostafasaqly.github.io/next-saqly-v16/"
          target="_blank"
          rel="noopener noreferrer"
          class="sidebar__course-link sidebar__course-link--next"
          :title="isAr ? 'كورس Next.js 16' : 'Next.js 16 Course'"
          :aria-label="isAr ? 'انتقل إلى كورس Next.js' : 'Go to Next.js Course'"
        >
          <svg class="sidebar__next-logo" viewBox="0 0 180 180" xmlns="http://www.w3.org/2000/svg">
            <mask id="next-mask" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="180" height="180">
              <circle cx="90" cy="90" r="90" fill="black"/>
            </mask>
            <g mask="url(#next-mask)">
              <circle cx="90" cy="90" r="90" fill="black"/>
              <path d="M149.508 157.52L69.142 54H54v71.97h12.114V69.384l73.885 95.461a90.304 90.304 0 0 0 9.509-7.325z" fill="url(#next-grad1)"/>
              <rect x="115" y="54" width="12" height="72" fill="url(#next-grad2)"/>
            </g>
            <defs>
              <linearGradient id="next-grad1" x1="109" y1="116.5" x2="144.5" y2="160.5" gradientUnits="userSpaceOnUse">
